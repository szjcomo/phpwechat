...
Class WechatError{
	...
	const ERRORLIST = [
		...
		'40014'=>'不合法的 access_token ，请比对 access_token 的有效性（如是否过期），或查看是否正在为恰当的公众号调用接口',
		'40015'=>'不合法的菜单类型',
		'40016'=>'不合法的按钮个数',
		'40017'=>'不合法的按钮个数',
		'40018'=>'不合法的按钮名字长度',
		...
		'-100001'=>'请求响应失败,请检查您的网络',
		'-100002'=>'json解析失败,请开启调式模式查看信息'
	];
	/**
	 * [getError 获取错误信息]
	 * @author szjcomo
	 * @DateTime 2019-09-02T12:39:07+0800
	 * @param    integer                  $code [description]
	 * @return   [type]                         [description]
	 */
	static function getError($code = 0):string
	{
		if(isset(self::ERRORLIST[$code])){
			return self::ERRORLIST[$code];
		}
		return '未知错误,请联系管理员';
	}
